...
public class pathology_Test_Controller {
	...
	@PostMapping("/")
	public ResponseEntity<Pathology_Test> SavePathologyTest(@RequestBody Pathology_Test_DTO pathology_Test_DTO ){
	...
	@GetMapping("/{id}")
	public ResponseEntity<Pathology_Test> GetPathologyTestById(@PathVariable("id")int id,@RequestBody Pathology_Test_DTO pathology_Test_DTO ){
	...
	@PutMapping("/{id}")
	public ResponseEntity<Pathology_Test> UpdatePathologyTestById(@PathVariable("id")int id,@RequestBody Pathology_Test_DTO pathology_Test_DTO ){
		Pathology_Test pathologyTest=pathology_Test_Service.getPathology_TestById(id);
		if(pathologyTest==null) {
			return new ResponseEntity<>(HttpStatus.NOT_FOUND);
		}
	...
	@DeleteMapping("/{id}")
	public ResponseEntity<Pathology_Test> DaletePathologyTestById(@PathVariable("id")int id,@RequestBody Pathology_Test_DTO pathology_Test_DTO ){
		Pathology_Test pathologyTest=pathology_Test_Service.getPathology_TestById(id);
		if(pathologyTest==null) {
			return new ResponseEntity<>(HttpStatus.NOT_FOUND);
