...
public class Test_Master_Contoller {
	...
	@PostMapping("/")
	public ResponseEntity<Test_Master> SaveTest_Master(@RequestBody Test_Master_DTO test_master_DTO){
		...
		Docter docter=docter_Service.getBYID(test_master_DTO.getDocterid());
		test_master.setDocterid(docter);
	...
	public ResponseEntity<List<Test_Master>> GetAllTest_Master(){
		...
		}return new ResponseEntity<>(test_Master,HttpStatus.FOUND);
	}
	...
	@PutMapping("/{id}")
	public ResponseEntity<Test_Master> UpdateDocterRecord(@PathVariable("id") int id, @RequestBody Test_Master_DTO test_master_DTO){
