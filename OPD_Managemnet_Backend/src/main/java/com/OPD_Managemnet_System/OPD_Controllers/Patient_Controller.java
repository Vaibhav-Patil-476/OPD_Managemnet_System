...
public class Patient_Controller {
	...
	@PostMapping("/")
	public ResponseEntity<Patient> SavePatient(@RequestBody Patient_Dto patient_Dto){
...
;		patient.setTobacoo(patient_Dto.getTobacoo());
		...
		Docter docter =	docter_Service.getBYID(patient_Dto.getDocterid());
	...
	@GetMapping("{id}")
	public ResponseEntity<Patient> GetPatientById(@PathVariable("id") int id , @RequestBody Patient_Dto patient_Dto){
	...
	@PutMapping("{id}")
	public ResponseEntity<Patient> UpadatePatientById(@PathVariable("id")int id ,@RequestBody Patient_Dto patient_Dto){
	...
	@DeleteMapping("{id}")
	public ResponseEntity<Void> DeletePatientById(@PathVariable("id") int id , @RequestBody Patient_Dto patient_Dto){
