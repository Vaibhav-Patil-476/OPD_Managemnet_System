...
public class Visit_Controller {
	...
	@PostMapping("/")
	public ResponseEntity<Visit> SavePetientVisit(@RequestBody Visit_DTO visit_DTO){
		...
		Docter docter= docter_Service.getBYID(visit_DTO.getDocterid());
		visit.setDocterid(docter);
	...
	@PutMapping("/{id}")
	public ResponseEntity<Visit> UpdateVisitById(@PathVariable("id") int id, @RequestBody Visit_DTO visit_DTO){
		...
		return new ResponseEntity<>(SavePatientVisit,HttpStatus.FOUND);
		
		
	}
	
	@DeleteMapping("/{id}")
	public ResponseEntity<Void> DeleteVisitById(@PathVariable("id") int id, @RequestBody Visit_DTO visit_DTO){
		Visit visit=visit_Service.getBYID(id);
		if(visit==null) {
			return new ResponseEntity<>(HttpStatus.NOT_FOUND);
