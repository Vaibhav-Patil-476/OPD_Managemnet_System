...
public class Visit {
	...
	public Visit(int id, Date date, String complaints, String diagnosis, String advice, String bp, String pulse,
			...
			String cvs, String rs, String pa, String cns, String hb, String ecg, Date followup_date,
			LocalDateTime create_at, LocalDateTime update_at, Docter docterid, Patient patientid) {
		super();
		this.id = id;
		this.date = date;
		this.complaints = complaints;
	...
	public String toString() {
		return "Visit [id=" + id + ", date=" + date + ", complaints=" + complaints + ", diagnosis=" + diagnosis
				...
				+ create_at + ", update_at=" + update_at + ", docterid=" + docterid + ", patientid=" + patientid + "]";
	}
